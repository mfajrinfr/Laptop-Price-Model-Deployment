...
def show_home():
    ...
    st.write(
        ...
        "Learning yang sudah dilatih sebelumnya. Aplikasi ini merupakan "
        "bagian dari project bootcamp Data Science, khususnya untuk tahap "
        "**model deployment**."
    )
...
"""
    ...
    st.caption(
        ...
        "demo/bootcamp. Hasil prediksi adalah estimasi statistik, bukan harga pasti."
    )
